...
* Температура (1)
* Четыре тарифа (4)
* Общую энергию по всем тарифам (1)
...
- 1.0.02
	- Добавлен тип `UNSIGNED32` для тарифов.
	- Изменен делитель для `Power`.
- 1.0.03
	- Устранена проблема с Power B и C.
- 1.0.04
	- Изменена внутренняя процедура сопряжения устройства с сетью.
	- Оптимизирована отправка отчетов по нажатию кнопки на устройстве.
	- Убраны принудительные отчеты делителей и множителей.
- 1.0.05
	- Исправлена передача нового пароля.
